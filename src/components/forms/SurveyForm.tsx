...
import { NavigationIconLink } from "../ui/NavigationIconLink";
...
export default function SurveyForm({
  ...
  const [data, setData] = useState<Record<string, string>>(prepopulatedData);
          ...
          <fieldset className="mb-4" name="ethnicity">
            ...
            <label className="inline-flex items-center">
              <input
                ...
                checked={data.ethnicity === "Hispanic or Latino"}
                onChange={handleInputChange}
              />
            ...
            <label className="inline-flex items-center">
              <input
                ...
                checked={data.ethnicity === "Not Hispanic or Latino"}
                onChange={handleInputChange}
              />
            ...
            <label className="inline-flex items-center">
              <input
                ...
                checked={data.ethnicity === "Prefer not to answer"}
                onChange={handleInputChange}
              />
